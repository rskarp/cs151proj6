...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
                 width=200, height=200, autoflush=True, doThisWhenKeyPressed = None):
        ...
        if doThisWhenKeyPressed != None:
            master.bind("<Key>", doThisWhenKeyPressed )
            #master.bind( "a", doThisWhenKeyPressed )
        self.height = height
        self.width = width
